...
public class Recommendation {
    ...
    @JdbcTypeCode(SqlTypes.JSON)// Tells Hibernate to use JSON type for this field
    @Column(columnDefinition = "json") //Specifies the database column should store JSON format
